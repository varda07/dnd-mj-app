...
const TIPS = [
  ...
  '🎲 Le mode Session ouvre un poste MJ, un poste par joueur et un écran TV.',
  ...
  '🌫 Le brouillard de guerre se peint au pinceau sur les cartes de combat.',
  ...
  '👁 En session, les notes MJ ne partent jamais côté joueurs.',
